...
public class TemplateFive extends FrameLayout {
	...
	public TemplateFive(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		View view = (View) mLayoutInflater.inflate(R.layout.templatefive, null);
		...
		iv_five = (ImageView) this.findViewById(R.id.iv_five);
		iv_six = (ImageView) this.findViewById(R.id.iv_six);
		ivs.add(iv_first);
		ivs.add(iv_second);
		ivs.add(iv_third);
		ivs.add(iv_fourth);
